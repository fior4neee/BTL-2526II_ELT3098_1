...
func main() {
	...
	// Allow local Web Admin and Tauri/Svelte client apps to call the Core API.
	// Required because the client runs on a different local origin, e.g. 127.0.0.1:1420.
