...
// Ephemeris represents satellite position data from orbit_calc
...
// EphemerisUpdate represents incoming ephemeris data from orbit_calc
type EphemerisUpdate struct {
	Data []Ephemeris `json:"data"`
}
